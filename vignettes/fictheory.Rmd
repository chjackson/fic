...
derive a correction for the bias estimator in the case where the estimate of the squared bias is negative 
...
model that gives an accurate estimate for a range of focuses
[ example of what situation: simple clinical prediction?  ]

present formula for 

may simply be calculated by averaging over the

bias correction is done before / after 

equivalent to AIC
[ is this where we average over all covariates in the data ?]
